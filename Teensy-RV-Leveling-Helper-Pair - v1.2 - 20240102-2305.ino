//
// Teensy RV Leveling Helper Pair using NRF24L01 - version 1.2 dated 01/02/2024 @2305
...
String VERSION0               = ("version 1.2 - 01/02/2024-2305");
String VERSION0_A             = ("Version 1.2");
String VERSION0_B             = ("01/02/2024-2305");
...
const int CHECK_BUTTONS_MILLIS = 100;
...
void process_buttons()
{
   ...
   tft.fillRect(0, 230, 110, 10, ILI9341_BLACK);
   ...
   if (button_pressed)
   {
      ...
      if ((repeat_delay == 1) || (repeat_delay > 10))
      {
         if (repeat_delay > 30)
         {
            repeat_delay = 30;
